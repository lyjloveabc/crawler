package com.freedom.crawler.sys.aspect;

import com.freedom.crawler.core.PrintUtil;
import com.freedom.crawler.core.RequestUtil;
...
public class ControllerLogAspect {
    ...
    //控制层切入点
    @Pointcut("execution(* com.freedom.crawler.controller.*.*.* (..))")
